              ...
              <div class="row tile_count">
                ...
                <div class="row">
                  <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                      <div class="x_title">
                        <h2>Homologaciones de Matrículas</h2>
                      ...
                      <div id="capa_lista_homologaciones" class="x_content">                        
                        <!-- Aqui va la Tabla con las Homologaciones-->
                        <?php require_once('source/tabla_lista_homologaciones.php'); ?>
                      </div>
                    </div>
                  </div>
