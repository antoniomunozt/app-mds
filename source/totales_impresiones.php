<?php 
    ...
    $sql = "Select sum(copias) as total_copias from mds_impresiones";

    $sql2 = "Select count(distinct id_manipulador) as Manipuladores from mds_impresiones";
    ...
    {
    $where = $where." and tipo_matricula=".$tipo ;
    }
...
<div class="row tile_count">
    <div class="col-md-3 col-sm-4 col-xs-6 tile_stats_count">
        <span class="count_top"><i class="fa fa-print"></i> Total Impresiones</span>
