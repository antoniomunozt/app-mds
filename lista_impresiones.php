              ...
              <div class="row tile_count">
                ...
                <div class="row">
                  <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                      <div class="x_title">
                        <h2>Listado de Impresiones Matrículas (Si no se filtra muestra sólo los 100 primeros Registros)</h2>
                      ...
                      <div id="capa_totales_impresiones" class="x_content">                        
                        <!-- Aqui va la fila de totales de Impresiones -->
                        <?php require_once('source/totales_impresiones.php'); ?>
                      </div>                


                      <div id="capa_lista_licencias" class="x_content">                        
                        <!-- Aqui va la Tabla con las Licencias-->
                        <?php require_once('source/tabla_lista_impresiones.php'); ?>
                      </div>
                    </div>
                  </div>
...
<script>
  jQuery(function($) {
      ...
      $('#datatable-buttons').DataTable({
          ...
          order: [[7, 'desc']], //Para ordenar por Fechaimpresion
          responsive: true,
          dom: 'Bfrtip',
          buttons: ['excel', 'pdf']
      });
